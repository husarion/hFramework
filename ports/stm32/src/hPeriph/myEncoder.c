...
const encoder_desc_t encoder_desc[] =
{
	...
	/* MYENCODER_HMOT1 */ ENCODER_ENTRY(GPIOA,  7, GPIOA,  6, APB1, TIM3, TIM3_IRQn),
	/* MYENCODER_HMOT2 */ ENCODER_ENTRY(GPIOA,  1, GPIOA,  0, APB1, TIM5, TIM5_IRQn),
#else
#  error no board
#endif
};
...
#elif BOARD(CORE2MINI)
ENCODER_IRQ(TIM3,          TIM3, MYENCODER_HMOT1)
ENCODER_IRQ(TIM5,          TIM5, MYENCODER_HMOT2)
#else
#  error no board
#endif
