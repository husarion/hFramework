...
DEFINE_PORT____(MYGPIO_EXT_I2C_SDA          ,  34, F,  1, -1)
DEFINE_PORT____(MYGPIO_EXT_I2C_SCL          ,  35, F,  0, -1)
DEFINE_PORT____(MYGPIO_RPI_SERIAL_TX        ,  36, A,  9, -1)
DEFINE_PORT____(MYGPIO_RPI_SERIAL_RX        ,  37, A, 10, -1)
DEFINE_PORT____(MYGPIO_RPI_BTN              ,  38, G,  5, -1)
DEFINE_PORT____(MYGPIO_RPI_GPIO_17          ,  39, G,  6, -1)
DEFINE_PORT____(MYGPIO_RPI_GPIO_04          ,  40, G,  7, -1)
DEFINE_PORT____(MYGPIO_RPI_GPIO_03          ,  41, G,  8, -1)
DEFINE_PORT____(MYGPIO_FT_SERIAL_TX         ,  42, B, 10, -1)
DEFINE_PORT____(MYGPIO_FT_SERIAL_RX         ,  43, B, 11, -1)
...
DEFINE_PORT____(MYGPIO_LED_1                ,  92, E,  4, -1)
DEFINE_PORT____(MYGPIO_LED_2                ,  93, E,  3, -1)
DEFINE_PORT____(MYGPIO_LED_3                ,  94, E,  2, -1)
