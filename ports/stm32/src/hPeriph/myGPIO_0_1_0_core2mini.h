...
DEFINE_PORT____(MYGPIO_MOT1_PWM             ,  26, B,  8, -1)
DEFINE_PORT____(MYGPIO_MOT1A_IN             ,  27, C, 15, -1)
DEFINE_PORT____(MYGPIO_MOT1B_IN             ,  28, C, 14, -1)
DEFINE_PORT____(MYGPIO_MOT1A_ENC            ,  29, A,  0, -1)
DEFINE_PORT____(MYGPIO_MOT1B_ENC            ,  30, A,  1, -1)
DEFINE_PORT____(MYGPIO_MOT2_PWM             ,  31, B,  9, -1)
DEFINE_PORT____(MYGPIO_MOT2A_IN             ,  32, A,  4, -1)
DEFINE_PORT____(MYGPIO_MOT2B_IN             ,  33, A,  5, -1)
DEFINE_PORT____(MYGPIO_MOT2A_ENC            ,  34, A,  6, -1)
DEFINE_PORT____(MYGPIO_MOT2B_ENC            ,  35, A,  7, -1)
