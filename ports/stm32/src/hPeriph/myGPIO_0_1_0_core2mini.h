...
DEFINE_PORT____(MYGPIO_RPI_CONSOLE          ,  15, A, 11, -1)
DEFINE_PORT____(MYGPIO_RPI_STATUS           ,  16, A, 12, -1)
...
DEFINE_PORT____(MYGPIO_SD_IN                ,  23, B,  3, -1)
DEFINE_PORT____(MYGPIO_SD_POWER_ON          ,  24, D,  7, -1)
DEFINE_PORT____(MYGPIO_MOT12_SLEEP          ,  25, C, 13, -1)
DEFINE_PORT____(MYGPIO_MOT2_PWM             ,  26, B,  8, -1)
DEFINE_PORT____(MYGPIO_MOT2A_IN             ,  27, C, 15, -1)
DEFINE_PORT____(MYGPIO_MOT2B_IN             ,  28, C, 14, -1)
DEFINE_PORT____(MYGPIO_MOT2A_ENC            ,  29, A,  0, -1)
DEFINE_PORT____(MYGPIO_MOT2B_ENC            ,  30, A,  1, -1)
DEFINE_PORT____(MYGPIO_MOT1_PWM             ,  31, B,  9, -1)
DEFINE_PORT____(MYGPIO_MOT1A_IN             ,  32, A,  4, -1)
DEFINE_PORT____(MYGPIO_MOT1B_IN             ,  33, A,  5, -1)
DEFINE_PORT____(MYGPIO_MOT1A_ENC            ,  34, A,  6, -1)
DEFINE_PORT____(MYGPIO_MOT1B_ENC            ,  35, A,  7, -1)
DEFINE_PORT____(MYGPIO_SERVO1_PWM           ,  36, B,  0, -1)
DEFINE_PORT____(MYGPIO_SERVO2_PWM           ,  37, B,  1, -1)
DEFINE_PORT____(MYGPIO_SERVO3_PWM           ,  38, B,  6, -1)
DEFINE_PORT____(MYGPIO_SERVO4_PWM           ,  39, B,  7, -1)
DEFINE_PORT____(MYGPIO_SERVO_POWER_ON       ,  40, B, 15, -1)
DEFINE_PORT____(MYGPIO_SERVO_ADC            ,  41, C,  0,  3)
DEFINE_PORT____(MYGPIO_SENS_POWER_ON        ,  42, B,  2, -1)
DEFINE_PORT____(MYGPIO_LED_1                ,  43, A, 15, -1)
DEFINE_PORT____(MYGPIO_LED_2                ,  44, B,  4, -1)
DEFINE_PORT____(MYGPIO_LED_3                ,  45, B,  5, -1)
DEFINE_PORT_IRQ(MYGPIO_BUTTON_1             ,  46, B, 12, -1, EXTI15_10_IRQn)
DEFINE_PORT____(MYGPIO_BAT_MEAS             ,  47, C,  1,  4)
...
DEFINE_ADC(3, 13) //  1 ADC123_IN13 MYGPIO_SENS2_DIGIA_INT_ADC
