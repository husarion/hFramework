...
//fix
DEFINE_PORT____(MYGPIO_MOT12_SLEEP          ,  24, C, 13, -1)
DEFINE_PORT____(MYGPIO_MOT2_PWM             ,  25, B,  8, -1)
DEFINE_PORT____(MYGPIO_MOT2A_IN             ,  26, C, 14, -1)
DEFINE_PORT____(MYGPIO_MOT2B_IN             ,  27, C, 15, -1)
DEFINE_PORT____(MYGPIO_MOT2A_ENC            ,  28, A,  0, -1)
DEFINE_PORT____(MYGPIO_MOT2B_ENC            ,  29, A,  1, -1)
DEFINE_PORT____(MYGPIO_MOT1_PWM             ,  30, B,  9, -1)
DEFINE_PORT____(MYGPIO_MOT1A_IN             ,  31, A,  5, -1)
DEFINE_PORT____(MYGPIO_MOT1B_IN             ,  32, A,  4, -1)
DEFINE_PORT____(MYGPIO_MOT1A_ENC            ,  33, A,  6, -1)
DEFINE_PORT____(MYGPIO_MOT1B_ENC            ,  34, A,  7, -1)

// DEFINE_PORT____(MYGPIO_MOT12_SLEEP          ,  24, C, 13, -1)
// DEFINE_PORT____(MYGPIO_MOT1_PWM             ,  25, B,  9, -1)
// DEFINE_PORT____(MYGPIO_MOT1A_IN             ,  26, A,  4, -1)
// DEFINE_PORT____(MYGPIO_MOT1B_IN             ,  27, A,  5, -1)
// DEFINE_PORT____(MYGPIO_MOT1A_ENC            ,  28, A,  6, -1)
// DEFINE_PORT____(MYGPIO_MOT1B_ENC            ,  29, A,  7, -1)
// DEFINE_PORT____(MYGPIO_MOT2_PWM             ,  30, B,  8, -1)
// DEFINE_PORT____(MYGPIO_MOT2A_IN             ,  31, C, 15, -1)
// DEFINE_PORT____(MYGPIO_MOT2B_IN             ,  32, C, 14, -1)
// DEFINE_PORT____(MYGPIO_MOT2A_ENC            ,  33, A,  0, -1)
// DEFINE_PORT____(MYGPIO_MOT2B_ENC            ,  34, A,  1, -1)
