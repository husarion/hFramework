...
#define startTimeout() (timeout_start_ms = sys.getRefTime())//(timeout_start_ms = millis())

// Check if timeout is enabled (set to nonzero value) and has expired
#define checkTimeoutExpired() (io_timeout > 0 && ((uint16_t)sys.getRefTime() - timeout_start_ms) > io_timeout)//(io_timeout > 0 && ((uint16_t)millis() - timeout_start_ms) > io_timeout)
...
// 	last_status = Wire.endTransmission();
	...
	i2cTxBuf[0] = reg;
	i2cTxBuf[1] = value;
	hSens1.i2c.write(address, i2cTxBuf, 2);
	last_status = 0;
}
...
// 	last_status = Wire.endTransmission();
	...
	uint8_t i2cTxBuf[3];
	i2cTxBuf[0] = reg;
	i2cTxBuf[1] = (value >> 8) & 0xFF;
	i2cTxBuf[2] = value       & 0xFF;
	hSens1.i2c.write(address, i2cTxBuf, 3);
	last_status = 0;
}
...
// 	last_status = Wire.endTransmission();
	...
	uint8_t i2cTxBuf[5];
	i2cTxBuf[0] = reg;
	i2cTxBuf[1] = (value >> 24) & 0xFF;
	i2cTxBuf[2] = (value >> 16) & 0xFF;
	i2cTxBuf[3] = (value >> 8) & 0xFF;
	i2cTxBuf[4] = value       & 0xFF;
	hSens1.i2c.write(address, i2cTxBuf, 5);
	last_status = 0;
}
...
// 	value = Wire.read();
	...
	hSens1.i2c.rw(address, &reg, 1, &value, 1);
...
// 	value |=           Wire.read();      // value low byte
	...
	hSens1.i2c.rw(address, &reg, 1, rxbuf, 2);
	value = rxbuf[0] << 8;
	value |= rxbuf[1];
...
// 	value |=           Wire.read();       // value lowest byte
	...
	hSens1.i2c.rw(address, &reg, 1, rxbuf, 4);
...
// 	last_status = Wire.endTransmission();
	...
	hSens1.i2c.write(address, i2cTxBuf, i);
	last_status = 0;
}
...
// 		*(dst++) = Wire.read();
// 	}
	hSens1.i2c.rw(address, &reg, 1, dst, count);
}
