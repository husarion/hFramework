...
#define VECT_TAB_OFFSET  0x10000 /*!< Vector Table base offset field.	//todo: dodalem dla bootloadera
...
/** @addtogroup STM32F4xx_System_Private_Variables
  ...
  */
  ...
  // uint32_t SystemCoreClock = 160000000;//168000000;
...
/******************************************************************************/
  ...
  if (HSEStatus == (uint32_t)0x01)
  {
    ...
    PWR->CR |= PWR_CR_PMODE;//PWR_CR_VOS; //todo: PWR_CR_PMODE;

    /* HCLK = SYSCLK / 1*/
    RCC->CFGR |= RCC_CFGR_HPRE_DIV1;

    /* PCLK2 = HCLK / 2*/
    RCC->CFGR |= RCC_CFGR_PPRE2_DIV2;	//todo: zmienilem RCC_CFGR_PPRE2_DIV2

    /* PCLK1 = HCLK / 2*/
    RCC->CFGR |= RCC_CFGR_PPRE1_DIV2;	//do kamery
